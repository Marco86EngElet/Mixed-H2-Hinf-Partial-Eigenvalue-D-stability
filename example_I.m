...
legend('open-loop','theorem 2','theorem 7 multistep','FontSize',10)
grid on;
...
%      32.3) Transient Response - partial multistep allocation                                 
[y_theorem_7_multistep_impulse_disturb,...
    t_theorem_7_multistep_impulse_disturb,...
    x_theorem_7_multistep_impulse_disturb] = ...
        impulse(system_y_theorem_7,0:0.01:14);

%      32.4) Control action - partial multistep allocation 
u_theorem_7_multistep_impulse_disturb(...
    1:size(x_theorem_2_impulse_disturb,1),1:n_u,1)=...
        x_theorem_7_multistep_impulse_disturb(:,:,1)*Kpf_theorem_7';
...
plot(t_theorem_2_step_disturb,u_theorem_2_step_disturb(1:end,2),'-r',...
     t_theorem_7_multistep_step_disturb,...
     u_theorem_7_multistep_step_disturb(1:end,2),'-b')
grid on;
set(findall(gcf, 'Type', 'line'), 'LineWidth', 2);% Set thickness for all lines
