...
% 15) Counting structure for partial allocation optimization
    ...
    if number_of_non_controlable_states == 0
        ...
        % 15.10.4) Make LMI for Re(s)<=-alpha_v
            Tilde_Lambda_Valpha = Tilde_Lambda_p+alpha_v*eye(n_p);
            set_LMIs = [ set_LMIs,...
                Tilde_Lambda_Valpha*Tilde_X+Tilde_X*Tilde_Lambda_Valpha'+...
                Tilde_Bu*Tilde_W+Tilde_W'*Tilde_Bu'<=-eps*eye(n_p)  ];
        

        % 15.10.5) Make LMI for Re(s)>=-beta_v
        
            Tilde_Lambda_Vbeta = -Tilde_Lambda_p-beta_v*eye(n_p);
            set_LMIs = [ set_LMIs,...
                Tilde_Lambda_Vbeta*Tilde_X+Tilde_X*Tilde_Lambda_Vbeta'-...
                Tilde_Bu*Tilde_W-Tilde_W'*Tilde_Bu'<=-eps*eye(n_p) ];
        

        % 15.10.6) Make LMI for abs(s)<=-r_d
        
            Tilde_Lambda_Dqr = Tilde_Lambda_p+q_d*eye(n_p); 
            set_LMIs = [ set_LMIs,...
                [ -r_d*Tilde_X,...
                  Tilde_Lambda_Dqr*Tilde_X+Tilde_Bu*Tilde_W;...
                  Tilde_X*Tilde_Lambda_Dqr'+Tilde_W'*Tilde_Bu',...
                  -r_d*Tilde_X ]...
                  <=-eps*eye(2*n_p)    ];
        ...
        % 15.10.7) Make LMI for -theta_s<=angle(s)<=theta_s
            ...
            Tilde_Lambda_psin = Tilde_Lambda_p*sin(theta_s);
            Tilde_Lambda_pcos = Tilde_Lambda_p*cos(theta_s);
            Tilde_Busin = Tilde_Bu*sin(theta_s);
            Tilde_Bucos = Tilde_Bu*cos(theta_s);
            set_LMIs =[ set_LMIs,...
                [ Tilde_Lambda_psin*Tilde_X+Tilde_X*Tilde_Lambda_psin'+...
                  Tilde_Busin*Tilde_W+Tilde_W'*Tilde_Busin',...
                  Tilde_Lambda_pcos*Tilde_X-Tilde_X*Tilde_Lambda_pcos'+...
                  Tilde_Bucos*Tilde_W-Tilde_W'*Tilde_Bucos';...
                  Tilde_X*Tilde_Lambda_pcos'-Tilde_Lambda_pcos*Tilde_X+...
...
% 29.9) Construct the coordinate points of the boundary curves
for i=1:100
...
figure
subplot(131)
impulseplot(system_y_theorem_1,system_y_theorem_7)
...
subplot(132)
stepplot(system_y_theorem_1,system_y_theorem_7)
...
subplot(133)
bodemag(system_y_theorem_1,system_y_theorem_7)
...
figure
subplot(131)
impulseplot(system_z_theorem_1,system_z_theorem_7)
...
subplot(132)
stepplot(system_z_theorem_1,system_z_theorem_7)
...
subplot(133)
bodemag(system_z_theorem_1,system_z_theorem_7)
...
[y_theorem_1_step_disturb,...
    t_theorem_1_step_disturb,...
    x_theorem_1_step_disturb] = ...
        step(system_y_theorem_1,0:0.01:14);

%      31.2) Control action - free allocation         
u_theorem_1_step_disturb(1:size(x_theorem_1_step_disturb,1),1:n_u,1)=...
    x_theorem_1_step_disturb(:,:,1)*Kpf_theorem_1';
...
u_theorem_7_step_disturb(...
    1:size(x_theorem_1_step_disturb,1),1:n_u,1)=...
...
[y_theorem_1_impulse_disturb,...
    t_theorem_1_impulse_disturb,...
    x_theorem_1_impulse_disturb] = ...
        impulse(system_y_theorem_1,0:0.01:14);

%      32.2) Control action - free allocation         
u_theorem_1_impulse_disturb(1:size(x_theorem_1_impulse_disturb,1),1:n_u,1)=...
    x_theorem_1_impulse_disturb(:,:,1)*Kpf_theorem_1';
...
u_theorem_7_impulse_disturb(...
    1:size(x_theorem_1_impulse_disturb,1),1:n_u,1)=...
...
subplot(121)
plot(t_theorem_1_impulse_disturb,u_theorem_1_impulse_disturb(1:end,1),'-r',...
     t_theorem_7_impulse_disturb,...
...
subplot(122)
plot(t_theorem_1_step_disturb,u_theorem_1_step_disturb(1:end,1),'-r',...
     t_theorem_7_step_disturb,...
...
figure
subplot(121)
plot(t_theorem_1_impulse_disturb,u_theorem_1_impulse_disturb(1:end,2),'-r',...
     t_theorem_7_impulse_disturb,...
...
subplot(122)
plot(t_theorem_1_step_disturb,u_theorem_1_step_disturb(1:end,2),'-r',...
     t_theorem_7_step_disturb,...
